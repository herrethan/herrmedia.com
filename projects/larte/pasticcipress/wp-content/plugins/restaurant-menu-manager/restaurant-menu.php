...
*
*/
function rm_list_categories($content = null) {
	//ob_start();

	/* Load Stylesheet */
	wp_enqueue_style('restaurant-menu-css', plugins_url('/restaurant-menu.css',__FILE__));
	
	?>
	<div class="menu-card-wrap clearfix">
	<?php	
	...
	foreach ( $menu_types as $menu_type ) {
		?>
		<a class="menu-card" href="#<?php echo $menu_type->slug; ?>">
			<img src="<?php echo z_taxonomy_image_url($menu_type->term_id, 'thumbnail'); ?>" />
			<span><?php echo $menu_type->name; ?></span>
		</a>
		<?php
	}
...
?>
<a class="break" id="<?php echo $menu_type->slug; ?>"></a>
<h2 class="menu-type"><?php echo $menu_type->name; ?></h2>
<a class="to-top" href="#">back to top <span>&#8963;</span></a>
<div>
...
add_shortcode('menu', 'rm_list_menu'); 
add_shortcode('menu-categories', 'rm_list_categories'); 
