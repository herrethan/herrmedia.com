    <article <?php post_class( "article" ); ?> id="post-<?php the_ID(); ?>" itemscope itemtype="http://schema.org/Article">
      ...
      <header class="post-header">
        <section class="header-meta">
          <time datetime="" class="post-date radius-4"><time datetime="<?php the_time( get_option( 'date_format' ) ); ?>" itemprop="datePublished" pubdate><?php the_time( get_option( 'date_format' ) ) ?></time></time>
        ...
        <h2 class="post-title" itemprop="name"><a href="<?php the_permalink(); ?>" rel="<?php esc_attr_e( 'bookmark','zinnia-theme' ); ?>" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a></h2>
      </header>
